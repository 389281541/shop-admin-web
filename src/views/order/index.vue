...
<script>
import {fetchOrderList, closeOrder, deleteOrder} from '@/api/order'
...
export default {
  ...
  methods: {
    ...
    handleViewOrder (index, row) {
      this.$router.push({path: '/trade/orderDetail', query: { id: row.id }})
    },
    ...
    handleDeliveryOrder (index, row) {
      ...
      this.$router.push({path: '/trade/deliverOrderList', query: {list: [listItem]}})
    },
    ...
    handleBatchOperate () {
      ...
      if (this.operateType === 1) {
        ...
        this.$router.push({path: '/trade/deliverOrderList', query: {list: list}})
