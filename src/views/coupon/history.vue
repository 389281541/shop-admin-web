  ...
  <div class="app-container">
    <div class="table-layout">
      ...
      <el-row>
        ...
        <el-col :span="4" class="table-cell">{{coupon.scopeType | formatUseType}}</el-col>
        <el-col :span="4" class="table-cell">
          <span v-if="coupon.useConditionType===0">无门槛</span>
          <span v-else-if="coupon.useConditionType===1">满{{coupon.useConditionLimit}}元可用</span>
        </el-col>
        <el-col :span="4" class="table-cell">{{coupon.amount}}元</el-col>
        <el-col :span="4" class="table-cell">{{coupon.endEffectTime | formatStatus}}</el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        <el-col :span="4" class="table-cell" style="font-size: 13px">
          {{coupon.startEffectTime|formatDate}}至{{coupon.endEffectTime|formatDate}}
        </el-col>
        <el-col :span="4" class="table-cell">{{coupon.publishNum}}</el-col>
        <el-col :span="4" class="table-cell">{{coupon.receiveNum}}</el-col>
        <el-col :span="4" class="table-cell">{{coupon.publishNum-coupon.receiveNum}}</el-col>
        <el-col :span="4" class="table-cell">{{coupon.useNum}}</el-col>
        <el-col :span="4" class="table-cell">{{coupon.publishNum-coupon.useNum}}</el-col>
      </el-row>
    </div>
    ...
    <div class="table-container">
      <el-table ref="couponHistoryTable"
        ...
        <el-table-column label="领取方式" width="100" align="center">
          <template slot-scope="scope">{{scope.row.receiveType | formatGetType}}</template>
        </el-table-column>
...
import {fetchCouponCustomerList as fetchList} from '@/api/couponCustomer'
